...
# Convolutional Model with more CNN layer
model = Sequential()
...
# Test Score accuracy
model.fit(x_train, y_train, validation_data=(x_val, y_val), epochs=2, batch_size=128, callbacks=[ModelCheckpoint('model.h5', verbose=1, save_best_only=True)])
score = model.evaluate(x_val, y_val, verbose=0)
print('Test loss:', score[0])
print('Test accuracy:', score[1])

# Test Score accuracy
model1.fit(x_train, y_train, validation_data=(x_val, y_val), epochs=2, batch_size=128, callbacks=[ModelCheckpoint('model1.h5', verbose=1, save_best_only=True)])
score = model1.evaluate(x_val, y_val, verbose=0)
print('Test loss:', score[0])
print('Test accuracy:', score[1])

example_product = "Nikon Coolpix A10 Point and Shoot appliance"
#example_product = " Nike T-Shirts are good for workout"
